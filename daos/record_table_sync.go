	...
	return dao.RunInTransaction(func(txDao *Dao) error {
		...
		if oldCollection == nil {
			...
			if newCollection.IsAuth() {
				cols[schema.FieldNameUsername] = "varchar NOT NULL"
				cols[schema.FieldNameEmail] = "varchar DEFAULT '' NOT NULL"
				cols[schema.FieldNameEmailVisibility] = "bool DEFAULT FALSE NOT NULL"
				cols[schema.FieldNameVerified] = "bool DEFAULT FALSE NOT NULL"
				cols[schema.FieldNameTokenKey] = "varchar NOT NULL"
				cols[schema.FieldNamePasswordHash] = "varchar NOT NULL"
				cols[schema.FieldNameLastResetSentAt] = "varchar DEFAULT '' NOT NULL"
				cols[schema.FieldNameLastVerificationSentAt] = "varchar DEFAULT '' NOT NULL"
			}
